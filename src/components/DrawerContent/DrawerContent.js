...
const ListItemWithPermission = withPermission(Drawer.Item);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <View style={styles.currentUser}>
        {currentUser?.isAuthenticated ? <Avatar.Image size={50} source={{ uri: image }} /> : null}
